...
import just.monika.IQ救不了主播你因为你反编译我端子.util.misc.MathUtil;
        ...
        for (Object o : mc.theWorld.loadedEntityList)
        {
            ...
            if (ent != mc.thePlayer)
            {
                if (((ent instanceof EntityPlayer)) && (!ent.isInvisible()))
                {
                    ...
                    float stringWidth = DokiDokiLegitClient.f.getStringWidth(str) / 2;
                    ...
                    mc.fontRendererObj.drawString(str, -DokiDokiLegitClient.f.getStringWidth(str) / 2, 0, -1);
