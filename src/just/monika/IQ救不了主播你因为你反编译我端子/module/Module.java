...
import just.monika.IQ救不了主播你因为你反编译我端子.management.Saveable;
import just.monika.IQ救不了主播你因为你反编译我端子.management.SubFolder;
import just.monika.IQ救不了主播你因为你反编译我端子.management.keybinding.Bindable;
import just.monika.IQ救不了主播你因为你反编译我端子.management.keybinding.KeyHandler;
...
import just.monika.IQ救不了主播你因为你反编译我端子.module.data.SettingsMap;
...
Toggleable {
    ...
    public static void loadSettings() {
        try {
            ...
            for (String line : fileContent) {
                String[] split = line.split(":");
                block3 : for (Module module : DokiDokiLegitClient.getModuleManager().getArray()) {
    ...
    public void toggle() {
        ...
        if (DokiDokiLegitClient.getModuleManager().isSetup()) {
            Module.saveStatus();
        }
        if (this.enabled) {
