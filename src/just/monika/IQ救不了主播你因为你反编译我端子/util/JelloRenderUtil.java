...
public class JelloRenderUtil
{
    ...
    public static void draw2RoundedRect(float x2, float y2, float x1, float y1, int borderC, int insideC) {
        ...
        JelloRenderUtil.drawVLine(x2 *= 2.0f, (y2 *= 2.0f) + 1.0f, (y1 *= 2.0f) - 2.0f, borderC);
        JelloRenderUtil.drawVLine((x1 *= 2.0f) - 1.0f, y2 + 1.0f, y1 - 2.0f, borderC);
        JelloRenderUtil.drawHLine(x2 + 2.0f, x1 - 3.0f, y2, borderC);
        JelloRenderUtil.drawHLine(x2 + 2.0f, x1 - 3.0f, y1 - 1.0f, borderC);
        JelloRenderUtil.drawHLine(x2 + 1.0f, x2 + 1.0f, y2 + 1.0f, borderC);
        JelloRenderUtil.drawHLine(x1 - 2.0f, x1 - 2.0f, y2 + 1.0f, borderC);
        JelloRenderUtil.drawHLine(x1 - 2.0f, x1 - 2.0f, y1 - 2.0f, borderC);
        JelloRenderUtil.drawHLine(x2 + 1.0f, x2 + 1.0f, y1 - 2.0f, borderC);
        JelloRenderUtil.drawRect(x2 + 1.0f, y2 + 1.0f, x1 - 1.0f, y1 - 1.0f, insideC);
    ...
    public static void drawRoundedRect( double d,  float y, double e,  float y1,  int borderC,  int insideC) {
        ...
        // drawHLine(x1 - 2.0F, x1 - 2.0F, y1 - 2.0F, borderC);
        // drawHLine(x + 1.0F, x + 1.0F, y1 - 2.0F, borderC);
        Gui.drawRect((int) (d + 1.0F), (int) (y + 1.0F), (int) (e - 1.0F), (int) (y1 - 1.0F), borderC);
        GL11.glScalef(2.0F, 2.0F, 2.0F);
        disableGL2D();
    }
    public static void drawVLine(double d, float y, float x1, int y1)
    {
        ...
        Gui.drawRect((int) d, (int) (y + 1.0F), (int) (d + 1.0F), (int) x1, y1);
    }
    public static void drawHLine(double d, double e, final float x1, final int y1) {
        ...
        Gui.drawRect((int) d, (int) x1, (int) (e + 1.0f), (int) (x1 + 1.0f), y1);
    }
